...
*/
bool at_ublox_c::PingTest(char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SetEcho(bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadFirmware(char* pFirmVer, char* pResp){
  *pFirmVer='\0';
	return true;
};
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadIMEI(char* pIMEI, char* pResp){
  char* pTemp;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadIMSI(char* pIMSI, char* pResp){
  char* pTemp;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadSIMID(char* pSIMID, char* pResp){
  char* pTemp;
...
/**
  ...
  @param[in] awakeTime Awaken time
	...
	@return TRUE done success
*/
bool at_ublox_c::SetPowerMode(uint8_t powerMode, int32_t awakeTime, char*pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SwitchOff(char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SetOperator(uint8_t mode, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadNetworkOperator(char* pInfo, char* pResp){
	char* pTemp;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadNetworkRegistrationStatus(uint8_t* pNwkRegStt, char* pResp){
	char* pTemp;
...
bool at_ublox_c::TestATCommand(char* pCmd, char* pResp){
  bool retResult;
  DB_Printf("Test AT: %s\n", pCmd);
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSSetTextMode(bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSSetShowHeader(bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSSelectService(bool isPhase2Plus, char* pResp){
	if (isPhase2Plus)	{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSSetNewIndication(uint32_t indicateMode, char* pResp){
...
/**
  ...
  @param[in] inEnable TRUE will send URC. FALSE won't send URC
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSSetWaitingIndicaition(bool isEnable, char* pResp){
  if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSSetPreferredStorage(bool isOnSIM, char* pResp){
	if (isOnSIM){
...
/**
  ...
  @return TRUE done success
*/
bool at_ublox_c::SMSSaveSetting(char* pResp){
...
*/
bool at_ublox_c::SMSReadAt(uint8_t index, char* pSentNum, char* pContent, char* pResp){
  char* pBuffer;
  char* pNum;
...
*/
bool at_ublox_c::SMSReadOldest(bool* hasSms, int32_t* pIndex, char* pSentNum, char* pContent, char* pResp){
	char* pStartSms;
  char* pNum = NULL;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSDeleteAt(int32_t index, char* pResp){
	bool result;
...
/**
  ...
  @param[in] includeUnread TRUE deleate unread message also
	...
	@return TRUE done success
*/
bool at_ublox_c::SMSDeleteAll(bool includeUnread, char* pResp){
  bool result;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPIOSetMode(uint16_t pinIndex, uint16_t pinMode, char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPIORead(uint16_t pinIndex, bool* pReadVal, char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPIOSet(uint16_t pinIndex, bool setVal, char* pResp)
{
	if (setVal)
	{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSSetAttach(bool isAttach, char* pResp){
  bool result;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSIsAttach(bool* pResult, char* pResp){
	*pResult = false;
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSSetAuthentication(uint8_t profileId, uint8_t type, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSSetAPN(uint8_t profileId, char* pAPN, char* pResp){	
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSSetUsername(uint8_t profileId, char* pUserName, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSSetPassword(uint8_t profileId, char* pPassword, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GPRSSetPDP(uint8_t profileId, bool isActive, char* pResp){
  bool result;
...
*/
/*
bool at_ublox_c::GPRSNewSocket(int8_t* socketID, char* pResp)
{
	*socketID = -1;
...
*/
/*
bool at_ublox_c::GPRSConnectTCP(uint8_t socketId, char* domain, uint16_t remotePort, char* pResp)
{
...
*/
/*
bool at_ublox_c::GPRSCloseTCP(uint8_t socketId, char* pResp)
{
...
*/
/*
bool at_ublox_c::GPRSSendData(uint8_t socketId, char* data, uint16_t dataLength, char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPResetParameters(uint8_t httpID, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPSetDomain(uint8_t httpID, char* pDomain, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPSetRemotePort(uint8_t httpID, uint32_t port, char* pResp){ 
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPSetUsername(uint8_t httpID, char* pUsername, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPSetPassword(uint8_t httpID, char* pPassword, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPSetAuthentication(uint8_t httpID, bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPSetCustomHeader(uint8_t httpID, uint8_t headerIdx, char* pHeaderName, char* pHeaderVal, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPGetRequest(uint8_t httpID, char* pUri, char* pSaveFileName, bool* pResult, char* pResp){
  char waitStr[12];
...
/**
  ...
  @param[in] pFileName Name of the file store HTTP get response
	...
	@return TRUE done success
*/
bool at_ublox_c::HTTPParseResponse(char* pFileName, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::FlashReadFile(char* pFileName, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::FlashDelFile(char* pFileName, char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetPower(bool isOn, uint8_t aidMode, uint32_t GNSSSystem, char* pResp){
	if (isOn){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetURC(bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetProfile(uint32_t code, char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSConfigData(uint8_t sensor, uint8_t responseType, uint32_t timeout, uint16_t accuracy, char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetFixData(bool isEnable, char* pResp)
{
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetFixData(char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetGeoPos(bool isEnable, char* pResp)
{
	if (isEnable)
	{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetGeoPos(char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetNumOfSatellites(bool isEnable, char* pResp)
{
	if (isEnable)
	{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetNumOfSatellites(char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetRMC(bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetRMC(char* pResp){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetVTG(bool isEnable, char* pResp)
{
	if (isEnable)
	{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetVTG(char* pResp)
{
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSSetSatelliteInfo(bool isEnable, char* pResp){
	if (isEnable){
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetSatelliteInfo(char* pResp)
{
...
/**
  ...
  @param[out] pData data out
	...
	@return TRUE done success
*/
bool at_ublox_c::GNSSGetULOCData(bool byGNSS, uint32_t timeOutInSec, uint32_t accuracyInMet, char* pData, char* pResp){
  char pattern[] = "+UULOC: ";
...
*/
/*
bool at_ublox_c::Read(at_ublox_cmd_t readPara, uint32_t timeOut, char* pResp)
{
	char buffer[20];
...
/**
	...
	@return TRUE done success
*/
bool at_ublox_c::Read(at_ublox_cmd_t readPara, char* pWait, uint32_t timeOut, char* pResp)
{
	char buffer[20];
	strcpy(buffer, table[readPara].code);
...
/**
  ...
  @param[in] pATCmd command to read
	...
	@return TRUE done success
*/
bool at_ublox_c::Read(char* pATCmd, uint32_t timeOut, char* pWait, char* pResp){
  SendStr(pATCmd);
...
/**
  ...
  @param[in] pATCmd command to read
	...
	@return TRUE done success
*/
bool at_ublox_c::ReadNoQuestionMark(char* pATCmd, uint32_t timeOut, char* pWait, char* pResp){
